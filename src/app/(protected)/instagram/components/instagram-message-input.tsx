...
import { AISuggestionsDialog } from "@/app/(protected)/chats/components/ai-suggestions-dialog";
import { AiPromptDialog } from "@/app/(protected)/chats/components/ai-prompt-dialog";
import { ChatNotesDialog } from "@/app/(protected)/chats/components/chat-notes-dialog";
...
type InstagramMessageInputProps = {
	contactId: string;
	igsid: string;
	userName?: string;
	onMessageSent?: () => void;
